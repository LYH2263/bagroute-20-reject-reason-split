...
def seed_if_empty(db: Session) -> None:
    ...
    db.add_all(
        [
            ...
            SubscriberStop(route_id=r1.id, seq=6, name="泡货样例（仅超体积）", weight_kg=5.0, volume_l=20.0),
            SubscriberStop(route_id=r1.id, seq=7, name="双超件样例", weight_kg=10.0, volume_l=22.0),
